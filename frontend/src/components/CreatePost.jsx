...
function CreatePost() {
  ...
  return (
    ...
    <div>
        ...
        <div className="h-40 w-full border border-x-0 border-t-0  border-b-neutral-700 text-white px-5 flex flex-col justify-between pb-5 mt-5 relative">
            ...
            <form action="">
                ...
                type="text" className=" resize-none no-scrollbar text-white bg-transparent  h-35 rounded-md w-100  outline-none flex items-start" placeholder="What's happening?" />
